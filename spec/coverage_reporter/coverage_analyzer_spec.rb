  ...
  describe "#call" do
    ...
    context "with real project data from uncovered.txt and modified.txt" do
      it "processes actual coverage and diff data correctly" do
        ...
        # Parse the hash data from the files
        uncovered_ranges = eval(uncovered_data) # rubocop:disable Security/Eval
        ...
        expected = {
          ...
          coverage_stats: {
            total_modified_lines:     678,
            uncovered_modified_lines: 5,
            covered_modified_lines:   673,
            coverage_percentage:      99.26
          }
        }

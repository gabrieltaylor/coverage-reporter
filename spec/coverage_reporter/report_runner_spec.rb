...
RSpec.describe CoverageReporter::ReportRunner do
  ...
  let(:uncovered_ranges_extractor_instance) { instance_double(CoverageReporter::CoverageRangesExtractor, call: coverage) }
  ...
  before do
    ...
    allow(CoverageReporter::CoverageRangesExtractor)
      .to receive(:new).with(coverage_report_data, source_dir: nil).and_return(uncovered_ranges_extractor_instance)
